...
namespace test
{
	...
	/* ---------------------------------------------------------
		SET CONTAINERS
	--------------------------------------------------------- */
	function _Test_unique_set(set: std.base.UniqueSet<Atomic<number>, any>): void
	{
		// CONSTRUCT ELEMENTS
		_Construct_set(set);
	...
	function _Test_multi_set(set: std.base.MultiSet<Atomic<number>, any>): void
	{
		// CONSTRUCT ELEMENTS
		_Construct_set(set);
	...
	function _Construct_set(set: std.base.SetContainer<Atomic<number>, any, any>): void
	{
		// INSERT ELEMENTS
	...
	/* ---------------------------------------------------------
		MAP CONTAINERS
	--------------------------------------------------------- */
	function _Test_unique_map(map: std.base.UniqueMap<Atomic<string>, number, any>): void
	{
		// CONSTRUCT ELEMENTS
		_Construct_map(map);
	...
	function _Test_multi_map(map: std.base.MultiMap<Atomic<string>, number, any>): void
	{
		// CONSTRUCT ELEMENTS
		_Construct_map(map);
	...
	function _Construct_map(map: std.base.MapContainer<Atomic<string>, number, any, any>): void
	{
		for (let i: number = 0; i <= 10; ++i)
			for (let j: number = 0; j < 3; ++j)
			{
